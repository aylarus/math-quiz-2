...
class Start:  # first window
    ...
    def __init__(self, parent):  # this function is called every time the class is being used to create a new object
        ...
        self.bg_image = self.bg_image.resize((450, 350),
                Image.ANTIALIAS)  # the sizing for the image
        ...
        self.heading_label = Label(self.quiz_frame,
                                   text='Welcome to the Algebra Quiz Program'
        ...
        self.user_label = Label(self.quiz_frame,
                                text='Click start quiz to begin the quiz\n OR Click exit quiz to exit the quiz'
                                , font=('Comic Sans MS', '11'),
                                bg='#A8F0E4')
...
class Starter:  # second window
    ...
    def __init__(self, parent):  # this function is called every time the class is being used to create a new object
        ...
        self.continue_button = Button(self.quiz_frame, text='Continue',
                font=('Comic Sans MS', '13', 'bold'), bg='#62E4CF',
    ...
    def __init__(self, parent):  # this function is called every time the class is being used to create a new object
      ...
      # if 1st place is available/ what they got
        ...
        self.listLabel = Label(
            self.end_frame,
            text='Well done!(＾▽＾)You are in 1st place'
                ,
            font=('Comic Sans MS', '11'),
            width=40,
            bg=background,
