...
class End:
    def __init__(self, parent): # this function is called every time the class is being used to create a new object
      ...
      start_button = Button (self.end_frame, text="start agian", width=10, font=("Comic Sans MS", "11"), command=self.start_agian, pady=10, padx=10)
      exit_button.grid(row=4, pady=20, padx=5, sticky=W)
